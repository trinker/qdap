...
#' 
#' @param range.list A complete list object in the form generated by cm_range.temp
#' @param v.name sn optional name for the column created for the list.var argument
#' @param list.var logical.  If TRUE creates a column for the data frame created by each range.list passed to cm_r2l
