...
#' @note It is recommended that the researcher actually codes on the out put from this file.  If a file already exists cm_df.transcript will append to that file.
