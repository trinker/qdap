#' Transcript Apply Frey Readability Statistic
#' 
...
#'         25), axes = FALSE, type = "n", xlab = "Average number of syllables per 100 words", 
#'         ylab = "Average number of sentences per 100 words", main = "Fry Graph for Estimating Reading Ages (grade level)", 
#'         xaxs = "i", yaxs = "i"))
