...
#' 
#' A helper function for cm_time2long that transforms the range coding structure from cm_time.temp (in list format) into a data frame of start and end times in long format.
#' 
#' @param time.list A complete list object in the form generated by cm_time.temp
#' @param list.var.name sn optional name for the column created for the list.var argument
