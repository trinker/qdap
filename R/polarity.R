...
#' these context cluster (\eqn{x_i^{T}}{x_i^T}) are summed and divided by the square 
#' root of the word count (\eqn{\sqrt{n}}{sqrt(n)}) yielding an unbounded polarity score 
#' (\eqn{\delta}{C}).  Note that context clusters containing a comma before the 
