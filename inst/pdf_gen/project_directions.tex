...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item \textbf{01\_clean\_data.R} intial cleaning of raw transcripts
    \item \textbf{02\_analysis\_I.R} intial analysis
  ...
  \begin{enumerate}
     \item \textbf{CONTACT\_INFO.txt} A txt file to put research team members' 
       contact information
     \item \textbf{project\_directions.pdf} A pdf explainging the structure of the project template
  \end{enumerate}  
  \item \textbf{DATA\_CLEANED} - A directory to store cleaned data (generally .RData 
     format)
  ...
  \item \textbf{extra\_functions.R} - A script to store user made functions related to the project
