...
<h4 id="bracket">Reading In Transcript Data `r yt("http://youtu.be/UxgOScggLBg")`</h4>
`r FT(gold, 5, text="&diams;")` **Reading In Data**- *read.transcipt* `r FT(gold, 5, text="&diams;")`
```{r}
