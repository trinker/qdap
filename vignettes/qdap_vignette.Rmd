...
To use `knitr` to build the HTML file from the Rmd file:

```{r eval=FALSE}
build_qdap_vignette()
```

or to download the latest CRAN version HTML use:
