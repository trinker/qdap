...
The `r FUN("replace_number")` function utilizes The work of John `r citet(bib["Fox2005"])` to turn numeric representations of numbers into their textual equivalents.  This is udeful for word statistics that require the text version of dialogue.
